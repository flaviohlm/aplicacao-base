...
//        }
    ...
    public String gotoPerfilEdit(Integer idPerfil) {
        perfil = new Perfil();
        return "/configuracoes/perfil/editar/index?id=" + idPerfil + "&faces-redirect=true";
    }

    public String gotoPerfilNew() {
        perfil = new Perfil();
        return "/configuracoes/perfil/editar/index?faces-redirect=true";
    }
